...
const listHeader = [
  {
    id: 19,
    image:
      "https://radarlampung.co.id/wp-content/uploads/2022/02/IMG-20220222-WA0016-1536x1148.jpg",
  ...
  },
  {
    id: 20,
    image:
      "https://radarlampung.co.id/wp-content/uploads/2022/02/IMG-20220215-WA0015.jpg",
  ...
  },
  {
    id: 21,
    image:
      "https://radarlampung.co.id/wp-content/uploads/2020/10/images-2020-10-29T200524.723.jpeg",
  ...
  },
  {
    id: 22,
    image:
      "https://radarlampung.co.id/wp-content/uploads/2022/02/IMG_20220215_213901.jpg",
  ...
  },
  {
    id: 23,
    image:
      "https://radarlampung.co.id/wp-content/uploads/2022/02/WhatsApp-Image-2022-02-10-at-15.36.24-1536x1006.jpeg",
    title:
      "Tegas ! Ini Pesan AHY ke Ketua Partai Demokrat Lampung Soal Wajib Rangkul Semua Pihak",
  ...
  },
  {
    id: 24,
    image:
      "https://radarlampung.co.id/wp-content/uploads/2022/02/WhatsApp-Image-2022-02-09-at-19.09.25-e1644412013217.jpeg",
    title:
      "Raih 114 Medali, Rafflesia Swimming Club Bandar Lampung Juara Umum Damraman Championship 2022",
...
const Beranda = ({ navigation }) => {
  ...
  const [data, setData] = useState(
    listBerita.filter((e) => e.kategori == "Berita Terbaru")
  );
  const [header, setHeader] = useState(
    listHeader.filter((e) => e.kategori == "Berita Terbaru")
  );
    ...
    <View style={styles.container}>
      ...
      <View style={{ paddingHorizontal: 15 }}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View>
            <Text
              style={{ fontSize: 18, fontWeight: "bold", color: "#0057A1" }}
            >
              {kategori}
            </Text>
            {header.map((item) => (
